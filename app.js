...
const SERVER_CALLBACK_URL_BASE = removeFinalSlash(process.env.SERVER_CALLBACK_URL_BASE);
const FINAL_CALLBACK_URL_BASE = removeFinalSlash(process.env.FINAL_CALLBACK_URL_BASE);
